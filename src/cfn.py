...
@task
@requires_project
def launch(pname, instance_id=None, alt_config=None, formula_revisions=None):
    ...
    bootstrap.update_stack(stackname, service_list=['ec2', 'sqs', 's3'], concurrency='serial', formula_revisions=formula_revisions)
