...
ALL_PROJECTS = [
    ...
    'project-with-cloudfront-error-pages', 'project-with-cloudfront-origins', 'project-with-cluster', 'project-with-cluster-suppressed', 'project-with-stickiness', 'project-with-multiple-elb-listeners',
