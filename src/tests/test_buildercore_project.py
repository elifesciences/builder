...
ALL_PROJECTS = [
    ...
    'project-with-db-params', 'project-with-db-params-mysql', 'project-with-rds-only', 'project-with-rds-encryption', 'project-with-rds-major-version-upgrade', 'project-with-rds-snapshot',
