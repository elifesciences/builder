...
TASK_LIST = [
    ...
    stack.list_stack_data_files,
    stack.generate_stack_data_file,
    stack.list_stack_data,
    stack.stack_data,
...
def _escape_split(sep, argstr):
    """
    Allows for escaping of the separator: e.g. task:arg=r'foo\\, bar' (ignore leading 'r', single backslash)
