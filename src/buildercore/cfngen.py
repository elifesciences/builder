...
def build_context_fastly(pdata, context):
    ...
    if pdata['aws'].get('fastly'):
        ...
        context['fastly'] = {
            ...
            'between-bytes-timeout': pdata['aws']['fastly'].get('between-bytes-timeout'),
            'error-threshold': pdata['aws']['fastly'].get('error-threshold'),
            'first-byte-timeout': pdata['aws']['fastly'].get('first-byte-timeout'),
