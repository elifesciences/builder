...
def render_rds(context, template):
    ...
    data = {
        ...
        # "lax-2015-12-31" from "lax--2015-12-31"
        # "lax-prod-1" from "lax--prod" on first replacement.
    ...
    # custom name changes if being replaced
    # todo: remove this custom name if possible, let CFN handle it.
